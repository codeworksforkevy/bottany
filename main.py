    ...
    if not getattr(bot, "_help_registered", False):
        try:
            ...
            if "already registered" in str(e).lower():
                ...
                logger.warning("Help module registration failed: %s", e)# Ensure /gaming product + /gaming year_part1 are registered once
...
# Ensure /console commands are registered once (history_of_the_consoles)
...
# Ensure /games commands are registered once (first_and_early_games_from_the_history)
