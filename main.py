...
try:
    from commands.belgian_chocolate import register_belgium_chocolate as register_belgian_chocolate
except ImportError:
    from commands.belgian_chocolate import register_belgium_chocolate
    register_belgian_chocolate = register_belgium_chocolate
...
async def on_ready():
    ...
    # ---- Enterprise Free Games Scheduler ----
    if not hasattr(bot, "_freegames_enterprise_started"):
        ...
        bot._freegames_enterprise_started = True
