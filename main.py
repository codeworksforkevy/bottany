...
# Free games registry (used by /freegames and weekly announcer)
FREEGAMES_PATH = os.path.join(DATA_DIR, "free_games_registry.json")
FREEGAMES_REG = load_json(FREEGAMES_PATH) if os.path.exists(FREEGAMES_PATH) else {"sources": []}
