...
class FreeGamesCog(commands.Cog):
    ...
    async def cmd_list(self, interaction: discord.Interaction):
        ...
        await interaction.followup.send(_compose_message(offers, title="Free games (current)"))
    ...
    async def cmd_epic(self, interaction: discord.Interaction):
        ...
        await interaction.followup.send(_compose_message(offers, title="Free games (Epic)"))
    ...
    async def cmd_gog(self, interaction: discord.Interaction):
        ...
        await interaction.followup.send(_compose_message(offers, title="Free games (GOG)"))
    ...
    async def cmd_weekly(self, interaction: discord.Interaction):
        ...
        offers = await self._fetch_all()
        await interaction.followup.send("Posting weekly announcement to #gaming (if configured).", ephemeral=True)
        await self._post_weekly_to_channel(offers)
